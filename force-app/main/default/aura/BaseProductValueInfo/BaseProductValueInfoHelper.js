({
    obtainWordPicklistValuesForBaseProduct : function(component, event) {
        var baseValueFullName = event.getParam("fullName");
        component.set('v.baseProductFullName',baseValueFullName);
        ...
        var action = component.get('c.retreiveWorldListPicklistValuesForDependentValue');
        action.setParams({
