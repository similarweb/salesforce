({
  ...
  handleJourneyInfoEvent: function (component, event, helper) {
    component.set(
      "v.recordsInTheJourney",
      event.getParam("recordsInTheJourney")
    );
    component.set(
      "v.averageJourneyTimeLastThreeHours",
      event.getParam("averageJourneyTimeLastThreeHours")
    );
    component.set(
      "v.completedRecordsInTheJourney",
      event.getParam("recordBrichingSLA")
    );
  },
  handleClick: function (component, event, helper) {
    ...
    if (a) {
      ...
      pathCmp.searchLead(
        component.find("input").get("v.value"),
