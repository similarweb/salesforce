({
	doInit : function(component, event, helper) {
        component.set('v.columns', [
            {label: 'Order', fieldName: 'Step_Order__c', type: 'number', sortable: true},
            {label: 'Step', fieldName: 'Step_Name__c', type: 'text'},
            {label: 'Status', fieldName: 'Active__c', type: 'boolean', editable: 'true'},
            {label: 'Step SLA (minutes)', fieldName: 'Step_SLA__c', type: 'text',editable: 'true'}            
        ]);
