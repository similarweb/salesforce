        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if(responseJson.success){      
                    ...
                    component.set('v.averageJourneyTimeLastThreeHours',data.averageJourneyTimeLastThreeHours);
                    component.set('v.recordBrichingSLA',data.completedRecordsInTheJourney);
                    ...
                    journeyInfoEvent.setParams({
                        ...
                        "averageJourneyTimeLastThreeHours":data.averageJourneyTimeLastThreeHours,
