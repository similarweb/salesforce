    ...
    action.setCallback(this, function (response) {
      ...
      if (state === "SUCCESS") {
        ...
        if (responseObj.success) {
          component.set(
            "v.opportunityAttachments",
            responseObj.content.fileWrapperList
          );
          if (
            responseObj.content.fileWrapperList[0] != null &&
            responseObj.content.fileWrapperList[0].ownerName ==
              "Salesforce Admin"
          ) {
          ...
          component.set(
            "v.relatedOpportunityId",
            responseObj.content.relatedOpportunityId
          );
          ...
          component.set(
            "v.isRelatedEnvelopesCompleted",
            responseObj.content.isRelatedEnvelopesCompleted
          );
  ...
  viewAllClickHandler: function (component, event) {
    ...
    urlEvent.setParams({
      url:
        ...
        "/related/CombinedAttachments/view"
    });
    urlEvent.fire();
  },
