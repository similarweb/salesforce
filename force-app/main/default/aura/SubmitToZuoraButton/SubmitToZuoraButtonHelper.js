      ...
      if (state === "SUCCESS") {
        ...
        if (responseObj.success) {
          ...
          this.showModalPopup(
            component,
            "Success!",
            'Success! The subscription was successfully created in Zuora and the billing account was processed with the relevant information. For any further question about the billing account or invoices, please reach out to <a href="mailto:billing@similarweb.com" id="mymailto">billing@similarweb.com</a>'
          );
        } else {
