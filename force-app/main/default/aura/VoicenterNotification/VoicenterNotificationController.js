  ...
  onLoad: function (cmp, event, helper) {
    ...
    window.setInterval(
      $A.getCallback(function () {
        ...
        if (
          callData.vclightniingcalldata &&
          callData.vclightniingcalldata != "undefined"
        ) {
          ...
          if (
            !(
              callData.vclightniingcalldata.callstatus == "Dialing" &&
              callData.vclightniingcalldata.direction == "Click2Call"
            )
          ) {
            utilityAPI.openUtility();
          }

          helper.RemoteFindIDByPhoneT1(
            callData.vclightniingcalldata.callerphone,
            callData.vclightniingcalldata.callstatus,
            callData.vclightniingcalldata.ivrid,
            callData.vclightniingcalldata.direction,
            cmp
          );
        }
      }),
  ...
  parseFindIDByPhone: function (result) {
    ...
    if (typeof Storage !== "undefined") {
      ...
      if (calls != null) {
        ...
        for (
          var callLength = calls.length, callIDX = 0;
          callIDX < callLength;
          callIDX++
        ) {
