        ...
        window.setInterval(
            $A.getCallback(function() { 
        		...
        		if(callData.vclightniingcalldata && callData.vclightniingcalldata != 'undefined'){
                    ...
                    helper.RemoteFindIDByPhoneT1(callData.vclightniingcalldata.callerphone, callData.vclightniingcalldata.callstatus, callData.vclightniingcalldata.ivrid, cmp);
        		}
            }), 1000
        );      
    },
