({
    doInit : function(component, event, helper) {
        ...
        var selectedWorldListPicklistValues = component.get('v.selectedWorldListPicklistValues');
        var selectedWorldListPicklistValueFullNames = [];

        selectedWorldListPicklistValues.forEach(selectedWorldListPicklistValue => selectedWorldListPicklistValueFullNames.push(selectedWorldListPicklistValue.value));
        component.set('v.selectedWorldListPicklistValueFullNames',selectedWorldListPicklistValueFullNames);
