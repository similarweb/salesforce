({
    onWorldListValueSelection : function(component, event, helper) {
        ...
        var worldPicklSelectedEvent = $A.get("e.c:WorldListValueSelected");
        worldPicklSelectedEvent.setParams({ "fullName" : event.currentTarget.dataset.value,"label" : event.currentTarget.dataset.label });
