({
    doInit : function (component){
        ...
        if(allRestrictedOptionsMap){
            ...
            let leadEnrichmentPicklistValues = allRestrictedOptionsMap['Lead Enrichment'];
            component.set('v.defaultPicklistValues',defaultPicklistValues);
            component.set('v.leadEnrichmentPicklistValues',leadEnrichmentPicklistValues);
        }
    },
                ...
                action.setCallback(this, function(response) {
                    ...
                    if(state === "SUCCESS") {
                        ...
                        if(responseObj.success){
                            helper.showToast('success','Success!','Base product values successfully saved!');
                            if(mode == 'Base product'){
