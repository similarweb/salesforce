({
  doInit: function (cmp) {
    ...
    req.onreadystatechange = function (event) {
      if (req.readyState == 4) {
        if (req.status === 200) {
          ...
          cmp.set(
            "v.setMeOnInit",
            "Please connect to SimilarWeb VPN in order to show this page."
          );
        }
      }
    };
    ...
    req.open(
      "GET",
      "https://datacollection-hermes-production.op-us-east-1.datacollection-grid.int.similarweb.io/health"
    );
    req.send(null);
  }
});
