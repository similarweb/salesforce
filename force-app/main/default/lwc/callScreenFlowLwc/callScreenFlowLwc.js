...
export default class CallScreenFlowLwc extends LightningElement {
  ...
  get alignmentClass() {
    switch (this.alignment) {
      case "center":
        return "slds-text-align_center slds-m-top_small";
      case "right":
        return "slds-text-align_right slds-m-top_small";
      case "left":
        return "slds-text-align_left slds-m-top_small";
      default:
  ...
  get computedModalClass() {
    ...
    const resolvedSize =
      sizeClassMap[this.modalSize?.toLowerCase()] || "slds-modal_medium";
  ...
  startFlow() {
    ...
    if (this.Input_Bool_Var !== undefined)
      inputs.Input_Bool_Var = this.Input_Bool_Var;
