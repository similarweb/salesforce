        ...
        getMQLScoreInfo({recordId: this.recordId,sObjectType:this.sobjectType })
            .then((result) => {
                if(result.isSuccess && result.isSuccess == true){
                    ...
                    this.biData.miniSitesVisits = result.biData.intent_num_of_minisites_visits__c  ;    // data.fields.BI_Data__r.value.fields.Intent_Log_Ins__c.value;
                    this.biData.invitedUsers = result.biData.intent_num_of_invite_users__c   ;   // data.fields.BI_Data__r.value.fields.Intent_Log_Ins__c.value;
                    this.biData.Intent_Num_of_Keyword_Lists = result.biData.Intent_Num_of_Keyword_Lists__c  ;    // data.fields.BI_Data__r.value.fields.Intent_Log_Ins__c.value;
                    this.biData.intent_num_of_package_page_visits = result.biData.intent_num_of_package_page_visits__c;      // data.fields.BI_Data__r.value.fields.Intent_Log_Ins__c.value;
                    ...
                    this.biData.dashboardsCreated = result.biData.intent_num_of_dashboards__c ; //    data.fields.BI_Data__r.value.fields.intent_num_of_dashboards__c.value;
                    this.biData.SI_Saved_Searches = result.biData.Intent_Num_of_SI_Saved_Searches__c   ; //    data.fields.BI_Data__r.value.fields.intent_num_of_dashboards__c.value;
                    this.biData.SI_Sales_Signals = result.biData.Intent_Num_of_SI_Sales_Signal__c   ; //    data.fields.BI_Data__r.value.fields.intent_num_of_dashboards__c.value;
                    this.biData.SI_Company_Signals = result.biData.Intent_Num_of_SI_Company_Overview_Signal__c  ; //    data.fields.BI_Data__r.value.fields.intent_num_of_dashboards__c.value;
                    this.biData.SI_Advanced_Searches = result.biData.Intent_Num_of_SI_Advanced_Searches__c  ; //    data.fields.BI_Data__r.value.fields.intent_num_of_dashboards__c.value;

                    // Process each field to get all values
                    this.processField('pricingPageVisit',result.biData.Intent_Pricing_Visits_Dates__c);
                    this.processCombinedField('hooks',result.biData.Mrkt_Pro_Hook_Clicked__c,result.biData.Mrkt_Pro_Hook_Clicked_Dates__c);
                    this.processCampaignMembers('campaignMembers',result.campaignMembers);

                    this.processField('handraises', result.biData.Contact_Us_Help_Timestamp__c);
                    this.processField('premiumCenterVisits', result.biData.Mrkt_Premium_Features_Dates__c);
                    ...
                    this.processField('pngDownloads', result.biData.intent_num_of_png_downloads__c);
                    ...
                    this.processField('latestDomainsComparisons', result.biData.Mrkt_Last_3_Compare_Websites__c, this.splitValuesSpecialCase);
                    this.processField('latestKeywords', result.biData.Mrkt_Last_3_Keyword_List__c);
                    this.processField('topTrialSections', result.biData.Intent_Trial_Section_and_Sub__c);
                    this.processField('latestMiniSitesVisited', result.biData.Intent_Minisite_Section_Visits__c);
                    this.processField('Industries', result.biData.Mrkt_Industries_Searched__c);
                }else{
